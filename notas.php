...
// Obtener todas las notas para calcular media, mediana y moda
$query = "SELECT c.nota
          FROM calificaciones c
          JOIN inscripciones i ON c.id_inscripcion = i.id_inscripcion
...
if (!empty($notas)) {
    ...
    if ($count % 2 == 0) {
        // Si hay cantidad par de elementos, promedio de los dos centrales
        $mediana = ($notas[$middle - 1] + $notas[$middle]) / 2;
    } else {
        // Si hay cantidad impar, el elemento central
        $mediana = $notas[$middle];
    }
    
    // Calcular Moda (valor más frecuente)
    $frecuencias = array_count_values($notas);
    arsort($frecuencias);
    $moda = key($frecuencias);
}

$estadisticas['media'] = $media;
$estadisticas['mediana'] = $mediana;
$estadisticas['moda'] = $moda;
?>
            ...
            <div class="col-md-3 mb-3">
                <div class="card stats-card bg-success text-white">
                    <div class="card-body text-center">
                        ...
                        <h4><?php echo $estadisticas['total_calificaciones'] > 0 ? number_format($estadisticas['media'], 1) : 'N/A'; ?></h4>
            ...
            <div class="col-md-3 mb-3">
                <div class="card stats-card bg-warning text-white">
                    <div class="card-body text-center">
                        ...
                        <h4><?php echo $estadisticas['total_calificaciones'] > 0 ? number_format($estadisticas['mediana'], 1) : 'N/A'; ?></h4>
                        <p class="mb-0">Mediana</p>
                    </div>
                </div>
            </div>
            <div class="col-md-3 mb-3">
                <div class="card stats-card bg-info text-white">
                    <div class="card-body text-center">
                        ...
                        <h4><?php echo $estadisticas['total_calificaciones'] > 0 ? number_format($estadisticas['moda'], 1) : 'N/A'; ?></h4>
                        <p class="mb-0">Moda</p>
                    </div>
                </div>
            </div>
